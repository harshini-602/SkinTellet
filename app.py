...
df=pd.read_csv(r"C:\Users\harsh\Documents\major and minor\Major code\dupipro\dupipro\dataset\dataset\updated_skincare_products.csv")

app = Flask(__name__, template_folder='C:/Users/harsh/Documents/major and minor/Major code/dupipro/dupipro/templates/templates')
app.secret_key = '4545'
...
loaded_model = load(r"C:\Users\harsh\Documents\major and minor\Major code\dupipro\dupipro\model\model\final_model.h5")
...
def recommend_products_based_on_classes(classes):
    ...
    for skin_condition in classes:
        ...
        if skin_condition_lower in df_columns_lower:
            ...
            filtered_products['Ingredients'] = filtered_products['Ingredients'].apply(lambda x: ', '.join(x.split(', ')[:6]))
